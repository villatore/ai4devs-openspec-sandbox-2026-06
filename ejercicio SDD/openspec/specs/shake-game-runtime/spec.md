...
Define the browser runtime of the single-file shake game: the game loop, input handling (pointer plus DeviceMotion / DeviceOrientation for shake detection), score state, and reset semantics.
